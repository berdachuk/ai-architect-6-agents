-- Replace legacy ChatMemory + custom ai_session layout with Spring AI Session JDBC schema
-- (spring-ai-community spring-ai-session-jdbc 0.2.x, PostgreSQL).

DROP TABLE IF EXISTS ai_session_event CASCADE;
